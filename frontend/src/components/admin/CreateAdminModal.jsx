...
const CreateAdminModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // For admin creating another admin, we'll use the superadmin endpoint
      // Note: This might need adjustment based on your backend permissions
      const response = await apiClient.post(
        ...
        {
          params: {
            orgId: JSON.parse(localStorage.getItem("user")).organisationId,
          },
        }
      );
